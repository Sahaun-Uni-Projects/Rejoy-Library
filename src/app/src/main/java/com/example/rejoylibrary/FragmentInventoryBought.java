...
public class FragmentInventoryBought extends Fragment {
    private final String TAG = "FragmentInventoryBought";

    private ArrayList<BookBuyRecord> records = new ArrayList<>();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_nav_inventory_bought, container, false);
    }
    ...
    private void loadRecords() {
        FirebaseDatabase.getInstance().getReference().child("bookBuyRecords")
    ...
    private void init_record(DataSnapshot snapshot) {
        BookBuyRecord record = BookBuyRecord.build(snapshot);
        BookBuyRecord delRecord = null;
        for (BookBuyRecord rec : records) {
    ...
    private void loadComponents() {
        ...
        this.rvRecords.setAdapter(new InventoryBoughtRVAdapter(getActivity(), this, records));
